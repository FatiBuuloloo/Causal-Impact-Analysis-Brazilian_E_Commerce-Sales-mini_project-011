# Causal Impact Analysis Brazilian E-Commerce Sales: Uncovering the Hidden Bottleneck in Rio de Janeiro's E-Commerce Sales

**Link:** [Kaggle](https://www.kaggle.com/datasets/enzoschitini/brazilian-e-commerce-public-dataset-by-olist?resource=download)

**Methodology:** Bayesian Structural Time Series (CausalImpact), Synthetic Control, Exploratory Data Analysis (EDA)
...
**Recommendations:**
1. **Logistics Restructuring:** The business must urgently audit its third-party logistics (3PL) partners serving the RJ route to negotiate better rates or find alternative carriers.
2. **Subsidized Shipping:** Temporarily allocate a portion of the marketing budget to subsidize freight costs in RJ until baseline shipping rates normalize.
3. **Localized Warehousing:** Consider establishing a micro-fulfillment center closer to or within RJ to drastically cut last-mile delivery costs.
